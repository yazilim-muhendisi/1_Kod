...
namespace tekno_egitim_web.data.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //    columns: table => new
            //    {
            //        sahis_id = table.Column<int>(nullable: false)
            //            .Annotation("SqlServer:Identity", "1, 1"),
            //        sahis_ad = table.Column<string>(maxLength: 100, nullable: true),
            //        sahis_soyad = table.Column<string>(maxLength: 100, nullable: true)
            //    },
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_Sahis", x => x.sahis_id);
            //    });
